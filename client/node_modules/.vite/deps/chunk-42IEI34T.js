...
function namehash(name) {
  ...
  while (current.length) {
    ...
    if (partition == null || partition[2] === "") {
      logger5.throwArgumentError("invalid ENS address; missing component", "name", name);
    }
...
function checkProperties(object, properties) {
  ...
  Object.keys(object).forEach((key) => {
    if (!properties[key]) {
      logger8.throwArgumentError("invalid object key - " + key, "transaction:" + key, object);
    }
  });
}
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-42IEI34T.js.map
